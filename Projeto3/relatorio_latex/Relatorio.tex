...
Com a utilização do get\_dummies, o número de variáveis aumentou de 20 para 54 variáveis independentes. Assim, Susan Li \cite{TowardsDataScience:2017} utilizou a técnica RFE (Recursive Feature Elimination) para reduzir a quantidade de features, basicamente lista-se as variáveis independente com os seus pValue por meio da função summary2 do módulo Logit. As features que tiveram o pValue maiores que 5\% seriam retirados manualmente da amostra. Mas o resultado não ficou bom, o precision, recall, f1-score ficaram em 74\%. 

Entretanto, o resultado ficou aquém do que se esperava: As métricas de precision, recall e f1-score ficaram em 74\%. Após a constatação, adotamos os procedimentos feitos por Nelson Chris \cite{Medium:2019} que mantem todos os 54 features ou variáveis independentes. Durante o treinamento e no cross-validation (CRV) a melhora nos resultados foi evidente, com todas as métricas maiores que 90\%. 
...
Os dados de treinamento foram treinados com o algoritmo LogisticRegression do módulo sklearn.linear\_model, e também com o DecisionTreeClassifer. O modelo foi obtido a partir da função fit (fitness) entre os dados de treinamento balanceados e normalizados de X e y.
...
Na próxima etapa foi obtido o vetor de predição do y por meio da função predict do modelo, com a qual foi gerado uma matriz de confusão entre o y real e o y predito, a curva ROC do modelo final e também o relatório de classificação por meio da função classification\_report do módulo sklearn.metrics, para obter os valores de accuracy, precision, recall e f1-score.

A matriz de confusão mostra uma matriz de 2 x 2, onde estão registrados os números de Falsos Positivos (FP), Falsos Negativos (FN), Verdadeiros Positivos (TP) e Verdadeiros Negativos (TN). Respostas verdadeiras são TP+TN, respostas falsas são FP+FN. A curva ROC é gerado com o módulo roc\_auc\_score to sklearn, bem como os valores de AUC (Area Under the Curve).


\subsection{Teste do Modelo}

Após realizar a predição do modelo obtido na etapa de treinamento dos dados utilizando a amostra de validação (CRV) como base para comparação, a mesma metodologia utilizada na etapa anterior é realizada na amostra de testes. Como tal amostra é separada da etapa de treinamento, a amostra de testes é importante para descobrirmos se o modelo está enviesado de alguma forma, ocasionando casos de \textit{Overfitting} caso tal afirmação seja verdadeira. 

Todo modelo tem um certo viés (\textit{bias}) e deve sempre ser revisado de tempos em tempos pois a obtenção de novos dados em um certo período pode ocasionar uma alteração do comportamento do modelo, de modo a ser o mais generalista possível.
...
foi utilizado o RFE (Recursive Feature Elimination), assim foram listados as 50, 40, 30, 20, 10 features mais importantes. 
  ...
  \begin{table}[!ht]       
        ...
        \label{qualy}
            \begin{tabular}{|c|c|c|c|}
                ...
                \hline
                \hline
                \hline age& 40+  & 40 $\pm$ 13 anos & pvalue \textgreater 1\% \\ 
                \hline contact& 10+ & c30257/t2626 &  no(c20020/t12863) \\ 
                \hline duration& 40+ & 9.1 $\pm$ 6.6 min &  no (3.6 $\pm$ 3.4) \\ 
                \hline campaign& 40+ & 1.7 $\pm$ 1.2 &  no(2.6 $\pm$ 2.8)\\ 
                \hline pdays& 40+ & 789 $\pm$ 405 dias &  no(984 $\pm$ 120)\\ 
                \hline previous& 30+ & 0.3 $\pm$ 0.7 &  no(0.1 $\pm$ 0.4)\\ 
                \hline emp.var.rate& 30+ & -1.2 $\pm$ 1.6 &  no(0.2 $\pm$ 0.4)\\ 
                \hline cons.price.idx& 40+ & 93.3 $\pm$ 0.6 &  no(93.6 $\pm$ 0.5)\\ 
                \hline cons.conf.idx& 40+ & -39.8 $\pm$ 5.9 &  no(-40.5 $\pm$ 4.3)\\ 
                \hline euribor3m& 40+& 2.1 $\pm$ 1.7 &  no(3.8 $\pm$ 1.6)\\ 
                \hline nr.employed& 40+ & 5094 $\pm$ 87 & no(5176 $\pm$ 64) \\ 
                \hline pdays\_no\_contact& 50+ & - &  N.S. \\ 
                \hline job\_blue\_collar& (10) & 1452 & no(7735) \\ 
                \hline job\_entrepreneur& 10+ & 162 & no(1197) \\ 
                \hline job\_housemaid& (10) & 125 & no(863) \\ 
                \hline job\_management& 20+ & 448 & no(2304) \\ 
                \hline job\_retired& 20+ & 1612 & no(1145) \\ 
                \hline job\_self-employed& 10+ & 159 & no(1152) \\ 
                \hline job\_services& 10+ & 441 & no(3280) \\ 
                \hline job\_student& 30+ & 564 & no(536) \\ 
                \hline job\_technician& 20+ & 1492 & no(5437) \\ 
                \hline job\_unemployed& 40+ & 166 & no(789) \\ 
                \hline job\_unknown& 10+ & 33 & no(264) \\ 
                \hline marital\_married& 20+ & 11748 & no(12729) \\ 
                \hline marital\_single& 20+ & 6544 & no(8943)  \\ 
                \hline marital\_unknown& 50+ & 12 & no(62), N.S.\\                
                \hline education\_basic.6y& (10) & 260 & no(1862) \\ 
                \hline education\_basic.9y& (10) & 796 & no(5036) \\ 
                \hline education\_high.school& (10) & 2395 & no(7580) \\ 
                \hline education\_illiterate& 50+ & 3 & no(14), N.S. \\                
                \hline education\_professional.course& (10)  & 1027 & no(4186) \\ 
                \hline education\_university.degree& (10)  & 5834 & no(9463) \\ 
                \hline education\_unknown& (10) & 348 &  no(1342) \\ 
                \hline default\_unknown& 20+ & 983 &  no(7305) \\ 
                \hline default\_yes& 50+ & - &  N.S., bug \\
                \hline housing\_unknown& 30+ & 116 &  no(790)\\ 
                \hline housing\_yes& 30+ & 10503 &  no(15745)\\ 
                \hline loan\_unknown& 30+ & 116 &  no(1224)\\ 
                \hline loan\_yes& 30+ & 1224 &  no(4991)\\ 
                \hline month\_aug& 20+ & 2277 &  no(4969)\\ 
                \hline month\_dec& 40+ & 197 &  no(85)\\ 
                \hline month\_jul& 20+& 2387 &  no(5886)\\ 
                \hline month\_jun& 20+ & 2028 & no(4289) \\ 
                \hline month\_mar& 30+ & 757 & no(236) \\ 
                \hline month\_may& 20+ & 3799 & no(236) \\ 
                \hline month\_nov& 10+ & 1172 & no(3327) \\ 
                \hline month\_oct& 30+ & 940 & no(364) \\ 
                \hline month\_sep& 30+ & 861 & no(286) \\ 
                \hline day\_of\_week\_mon& (10) & 1647 & no(6876) \\ 
                \hline day\_of\_week\_thu& 10+ & 2469 & no(6797) \\ 
                \hline day\_of\_week\_tue& 10+ & 2155 & no (6410) \\ 
                \hline day\_of\_week\_wed& 10+ & 2205 & no (6497) \\ 
                \hline poutcome\_nonexistent& 30+ & 13188 & no(3681) \\ 
                \hline poutcome\_success& (10) & 5942 & no(428) \\ 
                \hline 
            \end{tabular} 
...
no grupo dos 30, 40 e 50 mais importantes. O RFE (10) indica que a feature está entre as 10 mais importantes e, assim, pode estar em quaisquer grupos dos 20, 30, 40, 50 features mais importantes. Uma feature pode não ser significativa para a determinação do y (aceitação ou não do plano), mas o seu valor estatístico pode ajudar na intepretação do perfil do cliente.

O dash (-) indica que não existe o valor ou pode ser insignificante, enquanto a notação média (medium) $\pm$ desvio padrão (std) são utilizadas para as features numéricas. A coluna Valor Estatístico mostra valores para os casos positivos (aceitou o plano de depósito bancário) e eventualmente os casos negativos (i.e. não aceitou o plano) são 
...
Este trabalho pode ser avaliado por meio de comparação das métricas e pelas estratégias utilizadas.
...
\begin{center}
	\begin{table}[!ht]
		...
		\begin{tabular}{|c|c|c|c|c|c|}
			...
			\hline
			\hline
			AUC&0.95&0.91&0.74&-&0.71\\     %% no "&" at start of row
			\hline        %% extra \hline at bottom of table
